...
/* export default class MathFighterScene extends 
 Phaser.Scene
 {
    ...
    create(){
      ...
      this.player = this.physics.add.sprite(this.gameHalfWidth - 150, this.gameHalfHeight - 200, "player").setBounce(0).setOffset(-20, -9);
      this.physics.add.collider(this.player, tile);
      this.enemy = this.physics.add.sprite(this.gameHalfWidth + 150, this.gameHalfHeight - 200, "enemy").setBounce(0).setOffset(-20, -6).setFlipX(true);
      ...
      let start_button = this.add.image(this.gameHalfWidth, this.gameHalfHeight + 181, "start-btn") .setInteractive() .setScale(0.6);
      start_button.on(
        "pointerdown",
        () => {
    ...
    gameStart() {
      ...
      this.player.anims.play('player-standby', true);
      this.enemy.anims.play('enemy-standby', true);
      this.resultText = this.add.text(this.gameHalfWidth, 200, '0', { fontSize: '32px', color: '#000', fontFamily: "cursive" });
      this.questionText = this.add.text(this.gameHalfWidth, 100, '0', { fontSize: '32px', color: '#000', fontFamily: "cursive" });
